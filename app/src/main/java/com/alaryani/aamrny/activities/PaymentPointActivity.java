    ...
    public void initControl() {
        ...
        btnStripe.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (!txtPoint.getText().toString().trim().equals("")) {

                    Integer amount1 = Integer.parseInt(txtPoint.getText().toString().trim());
...
//                    startActivity(intent);
    ...
    private void payCardPayment(String point) {
        ...
        ModelManager.tabPayment(preferencesManager.getUserID(), txtPoint.getText().toString(), self, true,
                    ...
                    public void onSuccess(String json) {
                        if (ParseJsonUtil.isSuccess(json)) {
                            try {
                                ...
                                JSONObject jsonObject12 = jsonObject1.getJSONObject("data");
                                Intent intent = new Intent(PaymentPointActivity.this, PaymentWebViewActivity.class);
                                intent.putExtra("post_url", jsonObject12.getString("PaymentURL"));
                                if (isCurrentAppLangRtl())
                                    intent.putExtra("app_lang", "ar");
                                else
                                    intent.putExtra("app_lang", "en");
                                startActivity(intent);
                               /* Intent i = new Intent(Intent.ACTION_VIEW);
                                i.setData(Uri.parse(jsonObject12.getString("PaymentURL")));
                                startActivity(i);*/
        ...
        ModelManager.showInfoProfile(
                ...
                true, new ModelManagerListener() {
                    ...
                    public void onSuccess(String json) {
                        ...
                        if (ParseJsonUtil.isSuccess(json)) {
                            GlobalValue.getInstance().setUser(ParseJsonUtil.parseInfoProfile(json));
